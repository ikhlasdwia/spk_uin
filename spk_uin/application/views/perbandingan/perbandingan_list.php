...
$("#formentri").submit(function(e){
  ...
  $.ajax({
    type:'post',
    dataType:'json',
    url:"<?=base_url();?>Admin/Perbandingan/updateutama",
    data:$(this).serialize(),
    error:function(){
...
$("#prioform").submit(function(e){
  ...
  $.ajax({
    type:'post',
    dataType:'json',
    url:"<?=base_url();?>Admin/Perbandingan/kriteria_eigen",
    data:$(this).serialize(),
    error:function(){
...
<div class="">
  <div class="page-title">
    <div class="title_left">
      <h2>Perbandingan Data Kriteria</h2>
    </div>
  </div>
</div>
  <!-- <div id="respon"></div> -->
                          ...
                          if($noSub==$noUtama)
                          {
                            ...
                            {                 
                              ...
                              echo '<select name="'.$newname.'" id="k'.$noUtama.'b'.$noSub.'" data-target="k'.$noSub.'b'.$noUtama.'" data-kolom="'.$noSub.'" class="form-control inputnumber kolom'.$noSub.'" title="kolom'.$noSub.'">';
                                ...
                                $nilaix=$nilai[$k2][$xxx]; //id_kriteria_dari //id_kriteria_ujuan
                              for($x=1;$x<=9;$x++)
                              {
