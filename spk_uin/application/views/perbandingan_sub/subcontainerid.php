...
$("#formentri").submit(function(e){
  ...
  $.ajax({
    type:'post',
    dataType:'json',
    url:"<?=base_url();?>Admin/Perbandingan_sub/updatesub",
    data:$(this).serialize(),
    error:function(){
...
$("#prioform").submit(function(e){
  ...
  $.ajax({
    type:'post',
    dataType:'json',
    url:"<?=base_url();?>Admin/Perbandingan_sub/subkriteria_eigen",
    data:$(this).serialize(),
    error:function(){
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_content">
    			<div class="col-md-3">
    				...
    				<ul class="list-group">
    				  ...
    				  ?>
    						...
    						<a href="<?php echo base_url('admin/perbandingan_sub/perbandingan_sub_id/'.$rk->id_kriteria); ?>"><li class="list-group-item"><?php echo $rk->nama_kriteria; ?></li></a>
    				...
    				<?php	  
    				  ...
    				  <h3><?php echo $r->nama_kriteria ?></h3>
    				  <?php 
    				} ?>
    			</div>
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
              <p>Matrik Perbandingan Berpasangan</p>
              <?php
                echo form_open('#',array('class'=>'form-horizontal','id'=>'formentri'));

                  echo "<input type='hidden' id='kriteriaid' name='kriteriaid' value='".$kriteria_id."' />";
              ...
              <table class="table table-bordered table-striped table-hover jambo_table bulk_action js-basic-example dataTable">
                <thead>
                  <tr class="headings">
                    <th colspan="<?=$jumlah+1;?>" class="text-center">Kriteria</th>
                      <thead>
                          ...
                          for($i=1;$i<=$jumlah;$i++)
                          {
                            ...
                            if($noSub==$noUtama)
                            {
                              ...
                              {                 
                                ...
                                $nilaix=$nilai[$kriteria_id][$k2][$xxx];
              ...
              <div class="pull-left">
                ...
                <button type="submit" name="submit" class="btn btn-success">Simpan Subkriteria</button>  
              </div>
              <?php
                echo form_close();
              ?>
              ...
              <div id="matrikdiv" class="col-md-12" style="display: none">
                ...
                <input type="hidden" name="kriteriaid" value="<?=$kriteria_id;?>"/>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  foreach($arr as $k2=>$v2)
                  {
                    ...
                    echo '<td><input type="text" class="form-control" id="pri-b'.$noUtama2.'" name="pri-b['.$k2.']" value="0" readonly=""/></td>';
